    ...
    <AppShell active="/admin/payslips">
      ...
      {!rows.length ? (
        ...
        <div className="stack-lg">
          {rows.map((r) => (
            <div key={r.emp.id} className="card" style={{ pageBreakAfter: "always" }}>
              <div className="hd">
                <div>
              ...
              <div className="bd">
                <div className="slip-grid">
                  <div>
                    <div className="slip-sec">Payments</div>
                    <table>
                      <tbody>
                  ...
                  <div>
                    <div className="slip-sec">Deductions</div>
                    <table>
                      <tbody>
                    ...
                    <div className="slip-sec mt">Employer contributions (info only)</div>
                    <table>
                      <tbody>
